DROP TABLE IF EXISTS employee_addr_liv;

CREATE TABLE employee_addr_liv
(
	employee_addr_liv_id INTEGER GENERATED ALWAYS AS IDENTITY,
  ...
  postal_code VARCHAR(12),
	...
	CONSTRAINT pk_employee_addr_liv_employee_addr_liv_id PRIMARY KEY (employee_addr_liv_id),
  CONSTRAINT unq_employee_addr_liv_employee_id UNIQUE (employee_id),
  CONSTRAINT chk_employee_addr_liv_region CHECK (region != ''),
...
INSERT INTO employee_addr_liv(employee_id, country_id, city_id, street, building, appartment, floor, entrance, has_fence, postal_code)
     VALUES (1, 1, 1, 'Agtyes', '32', 141, 51, 'C', false, '33597'),
            (2, 1, 1, 'Hytroin', '124c', 101, 31, 'A', true, '58476'),
            (3, 3, 3, 'Abai', '45', 25, 6, 'B', true, '124005'),
            (4, 2, 2, 'Bolshevistskaya', '89a', 41, 10, '2', false, '940086');
